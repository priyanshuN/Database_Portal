<?php
    ...
    if($_GET['action']=='collab'){
        ...
        if(mysqli_num_rows($result)==1){
            ...
            $userid=$row['User_ID'];
            $sql1="select pro1.User_ID as GivenUser,pro2.User_ID as Collaborator from project_own as pro1,project_own as pro2 where pro1.Paper_ID=pro2.Paper_ID and pro1.User_ID!=pro2.Paper_ID and pro1.User_ID='$userid'";
